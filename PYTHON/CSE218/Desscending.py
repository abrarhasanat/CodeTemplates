...
Quick_x = []
Quick_y = []
with open('C:/Users/Asus/Desktop/temp/Descending CurveData for MergeSort.txt') as f:
    while True:
        line = f.readline()
        if not line:
            break
...
with open('C:/Users/Asus/Desktop/temp/Descending CurveData for QuickSort.txt') as f:
    while True:
        line = f.readline()
        if not line:
            break
